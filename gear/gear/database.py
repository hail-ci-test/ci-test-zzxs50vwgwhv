...
async def create_database_pool(config_file=None, autocommit=True, maxsize=10):
    if config_file is None:
        config_file = '/sql-config/sql-config.json'
...
class Database:
    ...
    async def async_init(self, config_file=None, autocommit=True, maxsize=10):
        self.pool = await create_database_pool(config_file, autocommit, maxsize)
